        ...
        assertThat(
                ...
                is(
                        new StringBuilder()
                                ...
                                .append("ID новой заявки: " + tracker.getAll().get(0).getId() + System.lineSeparator())
                                .append("Имя новой заявки: " + tracker.getAll().get(0).getName() + System.lineSeparator())
                                .append("Описание новой заявки: " + tracker.getAll().get(0).getDescription())
        ...
        assertThat(
            new String(this.out.toByteArray()),
                is(
                        ...
                        .append("ID заявки: " + tracker.getAll().get(0).getId() + System.lineSeparator())
                        .append("Наименование заявки: testName" + System.lineSeparator())
                        .append("Описание заявки: testDescription" + System.lineSeparator())
                        .append("ID заявки: " + tracker.getAll().get(1).getId() + System.lineSeparator())
