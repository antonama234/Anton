...
public class Logic3T {
    ...
    public boolean isWinnerX() {
        return this.fillBy(Figure3T::hasMarkX, 0, 0, 1, 0) ||
                ...
                this.fillBy(Figure3T::hasMarkX, 0, this.table.length - 1 - 1, 1, 0) ||
                this.fillBy(Figure3T::hasMarkX, this.table.length - 1 - 1, 0, 0, 1);
    }
    ...
    public boolean isWinnerO() {
        return this.fillBy(Figure3T::hasMarkO, 0, 0, 1, 0) ||
                ...
                this.fillBy(Figure3T::hasMarkO, 0, this.table.length - 1 - 1, 1, 0) ||
                this.fillBy(Figure3T::hasMarkO, this.table.length - 1 - 1, 0, 0, 1);
    }
